        ...
        try {
          ...
          if (product && product.externalId) {
            ...
            if (inviteResult.success) {
              ...
              logger.info(`Direct Telegram invite generated for ${sub.productType} ${product.name}`);
            } else {
              logger.warn(`Failed to generate direct Telegram invite for ${sub.productType} ${product.name}: ${inviteResult.error}`);
            }
          } else {
